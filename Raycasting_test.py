...
while True:
    ...
    pygame.draw.rect(win, (100, 100, 75), (480, SCREEN_HEIGHT / 2, SCREEN_HEIGHT, SCREEN_HEIGHT))
    pygame.draw.rect(win, (0, 150, 200), (480, -SCREEN_HEIGHT / 2, SCREEN_HEIGHT, SCREEN_HEIGHT))      
    ...
    if keys[pygame.K_s] or keys[pygame.K_DOWN]:
        forward = False
        player_x -= -math.sin(player_angle) * 2
        player_y -= math.cos(player_angle) * 2
